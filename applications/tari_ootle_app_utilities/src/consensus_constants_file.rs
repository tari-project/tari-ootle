...
pub struct ConsensusConstantsFile {
    ...
    pub probation_base_votes: Option<u64>,
    pub probation_base_blocks: Option<u64>,
    pub probation_max_backoff_exp: Option<u32>,
...
impl ConsensusConstantsFile {
    pub fn apply_to(self, constants: &mut ConsensusConstants) -> Result<(), ConsensusConstantsFileError> {
        ...
        set!(
            ...
            probation_base_votes,
            probation_base_blocks,
            probation_max_backoff_exp,
            max_block_weight,
