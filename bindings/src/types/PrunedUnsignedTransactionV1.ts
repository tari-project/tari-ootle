 ...
 */
export type PrunedUnsignedTransactionV1 = { network: number, fee_instructions: Array<Instruction>, instructions: Array<Instruction>, inputs: Array<SubstateRequirement>, min_epoch: Epoch | null, max_epoch: Epoch, is_seal_signer_authorized: boolean, dry_run: boolean, 
/**
