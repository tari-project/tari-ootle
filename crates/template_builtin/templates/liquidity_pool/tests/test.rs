...
fn contribute_and_redeem() {
    ...
    test.execute_expect_success(
        Transaction::builder_localnet()
            .allocate_component_address("stablecoin")
            ...
            .call_method("stablecoin", "contribute", args![
                Workspace("xtr_coins"),
    ...
    let vaults = indexed
        ...
        .collect::<HashMap<_, _>>();
    let pool_unit_resx = indexed.resource_addresses().first().cloned().unwrap();
    ...
    test.execute_expect_success(
        Transaction::builder_localnet()
            ...
            .assert_bucket_contains("redeemed_coins.0", XTR, 1000)
            .assert_bucket_contains("redeemed_coins.1", faucet_resource, 2000)
        ...
        Transaction::builder_localnet()
            .with_fee_instructions_builder(|builder| {
                ...
                builder
                    ...
                    .pay_fee_from_component(user2, 2000)
            })
