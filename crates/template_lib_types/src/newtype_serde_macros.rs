...
/// Low-level macro used for generating serde serializers/deserializers for newtype structs that should be represented
/// as string in human-readable contexts. Not intended for general usage
#[macro_export]
