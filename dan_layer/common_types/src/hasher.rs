...
pub use tari_hashing::layer2::TariConsensusHasher;
...
// pub fn tari_hasher<D: DomainSeparation>(label: &'static str) -> TariDomainHasher<D> {
//     TariDomainHasher::new_with_label(label)
// }
//
// pub type TariDomainHasher<M> = DomainSeparatedBorshHasher<Blake2b<U32>, M>;
//
