...
pub const SPARSE_MERKLE_PLACEHOLDER_HASH: Hash = Hash::new([0u8; Hash::byte_size()]);
...
impl InternalNode {
    ...
    fn merkle_hash(&self, start: u8, width: u8, (existence_bitmap, leaf_bitmap): (u16, u16)) -> Hash {
...
impl IsNotFoundError for JmtStorageError {
    fn is_not_found_error(&self) -> bool {
        matches!(self, JmtStorageError::NotFound(_))
    }
}
