...
<Aside type="caution" title="Prerequisite: Wallet Setup">
  ...
  <a href={basePath("/guides/setup-a-wallet/")}
     style="display:inline-block;margin-top:0.5rem;padding:0.4rem 1rem;background:var(--sl-color-accent);color:var(--sl-color-black);border-radius:0.375rem;text-decoration:none;font-weight:600;">Set
    up your Wallet →</a>
</Aside>
...
✅ WASM size: 148 KiB
⚠️ Publishing this template costs 67599 micro-TTARI, are you sure to continue? yes
