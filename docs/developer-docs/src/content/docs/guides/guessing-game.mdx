...
fn generate_number() -> u8 {
    ...
    let num = random_bytes(1)[0] as f32;
...
<Emgithub target="https://github.com/tari-project/wasm-template/blob/main/examples/guessing_game/Cargo.toml" />
<Emgithub target="https://github.com/tari-project/wasm-template/blob/main/examples/guessing_game/src/lib.rs" />
<Emgithub target="https://github.com/tari-project/wasm-template/blob/main/examples/guessing_game/tests/test.rs" />
