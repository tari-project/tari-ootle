...
- **Stealth:** Tokens can be transferred in confidential UTXOs. The native XTR token is an example of a stealth resource. Stealth resources provide enhanced privacy for asset holdings. Learn more about stealth resources in the <a href={basePath("/guides/stealth-resources/")}>Stealth Resources guide</a>.
