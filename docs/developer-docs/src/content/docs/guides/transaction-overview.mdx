...
See the <a href={basePath("/guides/guessing-game")}>Building a Guessing Game</a> guide for a worked example of testing a complete template.
...
- <a href={basePath("/guides/guessing-game")}>Build a Guessing Game
