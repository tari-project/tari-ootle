...
This guide expands on the basics, providing a deeper understanding of how to structure your Tari Ootle Templates.
...
This guide explains some details that are useful to know when writing templates.
If you just want to get started, you can skip to the next guide: <a href={basePath("/guides/guessing-game")}>Building a Guessing Game</a>.
...
<Aside type="note">
  TL;DR add this macro to your template module to make it work. Knowing the internal details is not necessary to write
  templates.
</Aside>
...
- Now that you know a little about templates, let's build a simple <a href={basePath("/guides/guessing-game")}>Guessing Game</a>.
