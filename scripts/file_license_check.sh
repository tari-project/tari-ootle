...
rg -i "Copyright.*The Tari Project" --files-without-match \
   -g '!*.{Dockerfile,asc,bat,config,config.js,css,csv,drawio,env,gitkeep,hbs,html,ini,iss,json,jsonc,lock,md,mdx,min.js,ps1,py,rc,scss,sh,sql,svg,toml,txt,yml,yaml,vue,liquid,otf,d.ts,config.ts,mjs,astro}' . \
